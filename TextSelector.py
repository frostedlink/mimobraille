...
class MIMOBraille(tk.Tk):
    def setup(self):
        ...
        os.system("ffplay -autoexit -nodisp "+"/home/MIMOBraille/Desktop/MIMOBraille/UI-Sounds/Digital_Text_Inputs.mp3")
    ...
    def texttobraille(self, frame_class):
        GPIO.cleanup()
        os.system("ffplay -autoexit -nodisp "+"/home/MIMOBraille/Desktop/MIMOBraille/UI-Sounds/Digital_Text_to_Braille.mp3")
        os.popen('sudo python3 /home/MIMOBraille/Desktop/MIMOBraille/Digital-Text-to-Braille.py')
        app.destroy()
    
    def texttospeech(self, frame_class):
        GPIO.cleanup()
        os.system("ffplay -autoexit -nodisp "+"/home/MIMOBraille/Desktop/MIMOBraille/UI-Sounds/Digital_Text_to_Speech.mp3")
        os.popen('sudo python3 /home/MIMOBraille/Desktop/MIMOBraille/Digital-Text-to-Speech.py')
        app.destroy()
