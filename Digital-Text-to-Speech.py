...
class MIMOBraille(tk.Tk):
    ...
    def checker(self):
        if not os.listdir('/media/MIMOBraille/Digital-Text to Speech Output/'):
            time.sleep(1)
            app.checker()
        else:
    ...
    def reader(self):
        for file in os.listdir("/media/MIMOBraille/Digital-Text to Speech Output/"):
            if file.endswith(".pdf"):
                new_name = r"/media/MIMOBraille/Digital-Text to Speech Output/output.pdf"
                os.rename(os.path.join("/media/MIMOBraille/Digital-Text to Speech Output/", file), new_name)
                pdfFileObj=open("/media/MIMOBraille/Digital-Text to Speech Output/output.pdf", "rb")
                ...
                new_name = r"/media/MIMOBraille/Digital-Text to Speech Output/output.docx"
                os.rename(os.path.join("/media/MIMOBraille/Digital-Text to Speech Output/", file), new_name)
                texts = docx2txt.process("/media/MIMOBraille/Digital-Text to Speech Output/output.docx")
                dtxt=open("/home/MIMOBraille/Desktop/MIMOBraille/output.txt","w")
                dtxt.write(texts)
                dtxt.close()
                clear()
                ...
                new_name = r"/media/MIMOBraille/Digital-Text to Speech Output/output.txt"
                os.rename(os.path.join("/media/MIMOBraille/Digital-Text to Speech Output/", file), new_name)
                original = r"/media/MIMOBraille/Digital-Text to Speech Output/output.txt"
...
def clear():
    for root, dirs, files in os.walk('/media/MIMOBraille/Digital-Text to Speech Output'):
        for f in files:
...
if __name__ == "__main__":
    app = MIMOBraille()
    app.title("Digital Text to Speech")
    setup()
    clear()
    app.mainloop()
